...
export default function Navigation() {
  ...
  return (
    <div
      ...
      className="navbar7_component w-nav"
      data-easing2="ease"
      data-easing="ease"
    ...
    >
      <div className="navbar7_container">
        ...
        <nav role="navigation" className="navbar7_menu w-nav-menu">
          <div className="navbar7_menu-left">
            ...
            >
              <div className="nav_dropdown-toggle w-dropdown-toggle">
                ...
                <div className="arrow-down-nav w-embed">
                  <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" className="iconify iconify--ic" width="100%" height="100%" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
                ...
                <a href="/products/lead-recommendation-agent" className="nav_link is-dropdown w-inline-block">
                  <div className="nav_link-icon w-embed">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                      <path d="M11 2C15.068 2 18.426 5.036 18.934 8.965L21.184 12.504C21.332 12.737 21.302 13.084 20.959 13.232L19 14.07V17C19 18.105 18.105 19 17 19H15.001L15 22H6V18.306C6 17.126 5.564 16.009 4.756 15.001C3.657 13.631 3 11.892 3 10C3 5.582 6.582 2 11 2ZM11 7C10.448 7 10 7.448 10 8V8.999L9 9C8.448 9 8 9.448 8 10C8 10.552 8.448 11 9 11L10 10.999V12C10 12.552 10.448 13 11 13C11.552 13 12 12.552 12 12V11H13C13.552 11 14 10.552 14 10C14 9.448 13.552 9 13 9H12V8C12 7.448 11.552 7 11 7Z" fill="currentcolor"></path>
                    </svg>
                  </div>
            ...
            <Link href="/post" className="nav_link w-inline-block">
              <div>Blog</div>
            </Link>
            <a href="https://trust.yess.ai/" target="_blank" rel="noopener noreferrer" className="nav_link w-inline-block">
              <div>Trust center</div>
            </a>
          </div>
          <div className="navbar7_menu-right">
            <a href="/login" className="button is-small w-button">Get Started</a>
          </div>
        </nav>
        <div className="navbar7_menu-button w-nav-button">
